      ...
      <div className="splash-inner">
        ...
        <div className="splash-cards">
          <div className="splash-card recommended" onClick={() => onSelect(2)}>
            ...
            <div className="sc-desc">El sistema clásico de Monge. Plano horizontal y plano vertical, con cuatro diedros. Ideal para el curso básico.</div>
          ...
          <div className="splash-card" onClick={() => onSelect(3)}>
            ...
            <div className="sc-desc">Sistema extendido con plano de perfil lateral. Permite representar alzado, planta y vista lateral simultáneamente.</div>
            <div className="sc-planes">
              <span className="sc-pill">Π₁ horizontal</span>
              <span className="sc-pill">Π₂ vertical</span>
